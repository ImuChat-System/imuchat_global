...
> ⚠️ L'app desktop étant à ~5%, l'implémentation ImuCompanion est **conditionnée** par la mise en place préalable des fondations (Supabase auth, Socket.IO, routing, stores). Cette roadmap suppose ces prérequis complétés.
...
|-----------|:------:|------|
| Shell Electron + Vite | ✅ | Fenêtre principale, menu, IPC de base |
| React 18 | ✅ | Composants basiques |
| TypeScript | ✅ | Config en place |
| electron-builder | ✅ | Config packaging |

### Prérequis absolus avant ImuCompanion

| Prérequis | Priorité | Effort estimé |
|-----------|:--------:|:-------------:|
| 🔴 Supabase client + auth | P0 | 2 semaines |
| 🔴 Socket.IO client | P0 | 1 semaine |
| 🔴 Routing (react-router ou routes app) | P0 | 1 semaine |
| 🔴 Zustand stores de base (auth, chat) | P0 | 1 semaine |
| 🟡 Stream Video SDK (appels) | P1 | 2 semaines |
| 🟡 Système de modules | P1 | 1 semaine |

> **Estimation prérequis** : ~8 semaines avant de pouvoir démarrer ImuCompanion.  
> Alternative : commencer IC-D1/IC-D2 offline-first en parallèle des prérequis.
...
| 3️⃣ | **Desktop** | App à ~5%. Nécessite prérequis importants. |
