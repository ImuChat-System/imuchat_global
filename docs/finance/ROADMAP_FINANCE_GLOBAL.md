...
|--------|--------|:-----:|---------|
| **IMUBANK 1** | Wallet | 2 sem. | Harmoniser types shared-types ↔ mobile, corriger noms tables |
| **IMUBANK 2** | Wallet | 2 sem. | 7 Edge Functions Stripe (checkout, webhook, payment methods) |
| **IMUBANK 3** | Wallet | 2 sem. | Gamification ↔ Wallet (claim mission, streaks, badges) |
| **IMUBANK 4** | Wallet | 2 sem. | Retrait (Stripe Connect), tests e2e wallet complet |

**Milestone :** ✅ Wallet ImuCoin MVP stable et testé  
...
| Sprint | Source | Durée | Contenu |
|--------|--------|:-----:|---------|
| **IMUBANK 5** | Wallet | 2 sem. | KYC réel niveaux 0-2 (Onfido) |
| **IMUBANK 6** | Wallet | 2 sem. | Finance Hub dashboard + navigation |
| **ECONOMY A1** | Economy | 2 sem. | Extension 15 types transactions IC + stats wallet |
| **IMUBANK 7** | Wallet | 2 sem. | P2P dans le chat (send, request) |
| **ECONOMY A2** | Economy | 2 sem. | Cycle économique IC complet (conversion IC↔fiat) |
| **IMUBANK 8** | Wallet | 2 sem. | Split Bill + Cagnottes de groupe |
