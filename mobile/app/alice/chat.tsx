...
const PERSONA_INFO: Record<string, { label: string; color: string; icon: string }> = {
        ...
        >
            ...
            >
                <TextInput
                    ...
                    placeholder={
                        t("alice.inputPlaceholder") || "Écrivez à Alice…"
                    }
