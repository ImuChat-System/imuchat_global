...
export default function AliceHomeScreen() {
  ...
  const handleNewConversation = useCallback(
    (personaId?: string) => {
      ...
      router.push("/alice/chat" as Href);
    },
  ...
  const handleOpenSettings = useCallback(() => {
    router.push("/alice/settings" as Href);
  }, [router]);
        ...
        >
          <View
            style={[
              ...
              {
                backgroundColor: (persona?.color || "#8B5CF6") + "20",
              },
            ]}
          >
            <Ionicons
              name={
                (persona?.icon as keyof typeof Ionicons.glyphMap) || "sparkles"
              }
              size={20}
          ...
          <View style={styles.conversationContent}>
            ...
            {lastMessage && (
              <Text
                ...
                numberOfLines={1}
              >
                {lastMessage.role === "assistant" ? "Alice : " : ""}
                {lastMessage.content}
              </Text>
            )}
          </View>
        ...
        <View style={[styles.header, { paddingHorizontal: spacing.md }]}>
          <View>
            ...
            <Text style={[styles.headerSubtitle, { color: colors.textMuted }]}>
              {t("alice.subtitle") || "Votre assistante intelligente"}
            </Text>
          </View>
          <TouchableOpacity
            style={[
