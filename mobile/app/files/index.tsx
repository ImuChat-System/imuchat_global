...
export default function FilesIndexScreen() {
  ...
  const handleCreateFolder = useCallback(async () => {
    ...
    await createFolder(t("files.newFolder"));
  ...
  const displayFiles =
    showSearch && searchQuery ? searchResults : filteredFiles;
      ...
      >
        ...
        <Pressable onPress={() => toggleFavorite(item.id)}>
          <Ionicons
            ...
            size={18}
            color={item.is_favorite ? "#FFB300" : colors.textSecondary}
          />
        </Pressable>
      </Pressable>
    );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          ...
          <Pressable
            style={styles.headerBtn}
            onPress={() => router.push("/files/trash")}
          >
            <Ionicons name="trash-outline" size={22} color={colors.text} />
          </Pressable>
          <Pressable
            style={styles.headerBtn}
            onPress={() => router.push("/files/storage")}
          >
        ...
        <View style={styles.selectionBar}>
          <Pressable onPress={clearSelection}>
            <Text style={styles.selectionText}>
              {selectionCount} {t("files.selected")}
            </Text>
          </Pressable>
      ...
      <View style={styles.toolbarRow}>
        <View style={styles.toolbarLeft}>
          <Text style={styles.countText}>
            {displayFiles.length} {t("files.items")}
          </Text>
        </View>
        <Pressable
          onPress={() => {
            const options: FileSortOption[] = [
              "updated",
              "name",
              "size",
              "type",
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.folderCount}>
                    {folder.file_count} {t("files.items")}
                  </Text>
                </View>
              </Pressable>
            ))}
      ...
      {showCreateMenu && (
        <View style={styles.fabMenu}>
          ...
          <Pressable
            ...
            onPress={() => {
              setShowCreateMenu(false);
              showToast(t("files.uploadComingSoon"), "info");
            }}
          >
            <Ionicons
          ...
          <Pressable
            ...
            onPress={() => {
              setShowCreateMenu(false);
              showToast(t("files.cameraComingSoon"), "info");
            }}
          >
