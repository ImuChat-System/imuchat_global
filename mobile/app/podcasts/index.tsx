...
export default function PodcastsScreen() {
  ...
  const renderShowCard = (show: PodcastShow) => (
    ...
    >
      ...
      <Text
        style={[styles.showAuthor, { color: colors.textMuted }]}
        numberOfLines={1}
      >
        {show.author}
      </Text>
    ...
    return (
      ...
      >
        <View style={styles.historyInfo}>
          ...
          <Text
            style={[styles.historyShow, { color: colors.textMuted }]}
            numberOfLines={1}
          >
            {entry.show.title}
          </Text>
  ...
  const showsToDisplay =
    searchQuery.trim().length >= 2 ? searchResults : catalogShows;
      ...
      {currentEpisode && currentShow && (
        ...
        >
          <View style={styles.miniPlayerInfo}>
            ...
            <Text
              style={[styles.miniPlayerShow, { color: colors.textMuted }]}
              numberOfLines={1}
            >
              {currentShow.title}
            </Text>
