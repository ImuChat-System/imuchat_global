    ...
    >
      ...
      <View style={styles.artworkContainer}>
        {currentEpisode.artwork_url || currentShow.artwork_url ? (
          <Image
            source={{
              uri: currentEpisode.artwork_url || currentShow.artwork_url || "",
            }}
      ...
      <Text
        style={[styles.showTitle, { color: colors.textMuted }]}
        numberOfLines={1}
      >
      ...
      {showChapters && chapters.length > 0 && (
        <View
          style={[styles.chaptersSection, { marginHorizontal: spacing.md }]}
        >
