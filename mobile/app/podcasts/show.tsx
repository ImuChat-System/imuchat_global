          ...
          <View style={[styles.header, { paddingHorizontal: spacing.md }]}>
            ...
            <View style={styles.headerTop}>
              ...
              <View style={styles.headerInfo}>
                ...
                <Text
                  style={[styles.headerAuthor, { color: colors.textMuted }]}
                >
                  {show.author}
                </Text>
                <Text
                  style={[styles.headerEpisodes, { color: colors.textMuted }]}
                >
            ...
            {/* Description */}
            <Text
              style={[styles.headerDescription, { color: colors.text }]}
              numberOfLines={4}
            >
              {show.description}
            </Text>
