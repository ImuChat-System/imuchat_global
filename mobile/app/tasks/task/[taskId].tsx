...
export default function TaskDetailScreen() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      showToast(t("tasks.loadTaskError"), "error");
    } finally {
      setLoading(false);
    }
  }, [taskId, t]);
  ...
  const handleStatusChange = async (newStatus: TaskStatus) => {
    ...
    try {
      ...
      showToast(t("tasks.statusChangeError"), "error");
    }
  };
  ...
  const handlePostComment = async () => {
    ...
    try {
      ...
      showToast(t("tasks.commentError"), "error");
    } finally {
  ...
  const handleDeleteComment = (commentId: string) => {
    Alert.alert(t("tasks.deleteComment"), t("tasks.deleteCommentConfirm"), [
      { text: t("common.cancel"), style: "cancel" },
      {
        text: t("common.delete"),
        style: "destructive",
            ...
            styles.statusChip,
            {
              backgroundColor:
                task?.status === status
                  ...
                  : colors.surface,
              borderColor:
                task?.status === status ? colors.primary : colors.border,
            },
          ]}
        ...
        >
          <Text
            style={[
              styles.statusText,
              {
                color: task?.status === status ? colors.primary : colors.text,
              },
            ]}
          >
                  ...
                  <View style={styles.datePickerSimple}>
                    ...
                    >
                      {[
                        ...
                        const isSelected =
                          dueDate?.toDateString() === optionDate.toDateString();
                        return (
                          <TouchableOpacity
                            key={option.days}
                            style={[
            ...
            <View style={styles.section}>
              ...
              <View style={styles.checklistContainer}>
                {checklist.map((item) => (
                  ...
                  >
                    <Ionicons
                      name={item.done ? "checkbox" : "checkbox-outline"}
                      size={20}
