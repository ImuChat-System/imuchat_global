...
export default function TaskCreateScreen() {
  ...
  const handleSubmit = async () => {
    if (!title.trim()) {
      showToast(t("tasks.titleRequired"), "warning");
      return;
    }
    if (!selectedProjectId) {
      showToast(t("tasks.projectRequired"), "warning");
      return;
    }
    ...
    try {
      ...
      showToast(t("tasks.createTaskError"), "error");
    } finally {
      setLoading(false);
    }
  };
        ...
        >
                    ...
                    styles.statusChip,
                    {
                      backgroundColor:
                        status === s.value
                          ...
                          : colors.surface,
                      borderColor:
                        status === s.value ? colors.primary : colors.border,
                    },
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          status === s.value ? colors.primary : colors.text,
                      },
                    ]}
                  >
                    {s.label}
          ...
          <View style={styles.section}>
            ...
            >
              ...
              >
                {dueDate ? dueDate.toLocaleDateString() : t("tasks.selectDate")}
              </Text>
              {dueDate && (
                <TouchableOpacity
            ...
            {showDatePicker && (
              ...
              >
                <Text
                  style={[styles.datePickerLabel, { color: colors.textMuted }]}
                >
                  {t("tasks.selectDate")}
                </Text>
              ...
              <View style={styles.checklistContainer}>
                {checklist.map((item) => (
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[styles.checklistLabel, { color: colors.text }]}
                    >
                      {item.text}
                    </Text>
                    <TouchableOpacity
